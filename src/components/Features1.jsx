...
export const Features1 = () => {
  return (
      <section
          className="w-full bg-bgDark2 -mt-8  mb-8 sm:-mt-8 sm:mb-24 xl:-mt-8 2xl:mt-0 "
          id="features"
      >
        <div className="relative w-screen flex justify-center ">
          <div className="shape-divider-bottom-1665343298  lg:block">
            <svg
                data-name="Layer 1"
        ...
        >
          <div
            ...
            <div
                className="w-3/4 mx-auto lg:w-1/2 flex flex-wrap lg:-mx-4 sm:pr-8 lg:pt-10 justify-center lg:pl-4 xl:px-8">
